...
import PersonJsonConfig from "config/person_config.json";
...
const MapItems = [
    ...
    { navpropname: "ODetails", uicomponent: "otherdetails", expand: "ODetails", exclude: [], func: Support.AddOrUpdateOtherDetails, child: true },
...
const FetchProductInfo = async () => {
    ...
    return new Promise(async (resolve) => {
        const keyItems = Object.keys(PersonJsonConfig);
        keyItems.forEach(elm => {
            let items = [];
            for (let prop of PersonJsonConfig[elm]) {
